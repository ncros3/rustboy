...
impl Instruction {
    ...
    pub fn from_long_byte(long_byte: u8) -> Option<Instruction> {
        match long_byte {
            ...
            0x20 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::B)),
            0x21 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::C)),
            0x22 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::D)),
            0x23 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::E)),
            0x24 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::H)),
            0x25 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::L)),
            0x26 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::HL)),
            0x27 => Some(Instruction::SA(Direction::LEFT, IncDecTarget::A)),

            // shift right instructions
            0x28 => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::B)),
            0x29 => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::C)),
            0x2A => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::D)),
            0x2B => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::E)),
            0x2C => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::H)),
            0x2D => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::L)),
            0x2E => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::HL)),
            0x2F => Some(Instruction::SA(Direction::RIGHT, IncDecTarget::A)),
